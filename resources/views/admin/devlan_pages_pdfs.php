            ...
            <div class="col-12 col-lg-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">PDF Based Projects </li>
                    </ol>
                </nav>
              <div class="card card-table">
                <div class="card-header">
                  ...
                  <div class="title">PDF Based Projects </div>
                </div>
                ...
                <div class="card-body table-responsive">
                  <table class="table table-striped table-hover">
                    ...
                    <?php
                                            ...
                                            $ret="SELECT * FROM projects   where project_category = 'PDF`s'  ";
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href='devlan_pages_view_pdf_project.php?project_id=<?php echo $row->project_id;?>' class="mdi mdi-eye-outline"></td>
                      </tr>
                     </tbody>
                     <?php $cnt=$cnt+1; } ?>
                  </table>
