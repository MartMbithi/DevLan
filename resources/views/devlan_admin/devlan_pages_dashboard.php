      ...
      <div class="be-content">
        <div class="main-content container-fluid">
          ...
          <!--PDF CHEAT SHEETS-->
            <div class="col-12 col-lg-6 col-xl-3">
                ...
                <div class="chart sparkline" ><i class="material-icons">memory</i></div>
                  ...
                  ?>
                    ...
                    <div class="value"><span class="indicator indicator-equal mdi mdi-chevron-right"></span><span class="number" data-toggle="counter" data-end="<?php echo $members;?>">0</span>
                    </div>
                  </div>
                </div>
            </div>
            ...
            <div class="col-12 col-lg-6 col-xl-3">
              ...
              <div class="chart sparkline" ><i class="material-icons">router</i></div>
                ...
                <?php
                  ...
                  <div class="value"><span class="indicator indicator-positive  mdi mdi-chevron-right"></span><span class="number" data-toggle="counter" data-end="<?php echo $netwoking_projects;?>" data-suffix="">0</span>
                  </div>
                </div>
              </div>
            </div>
            <!--./End Netwokring projects-->
            ...
            <div class="col-12 col-lg-6 col-xl-3">
              ...
              <div class="chart sparkline" ><i class="material-icons">code</i></div>
                ...
                <?php
                  ...
                  <div class="value"><span class="indicator indicator-positive mdi mdi-chevron-right"></span><span class="number" data-toggle="counter" data-end="<?php echo $coding_projects;?>">0</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-12 col-lg-6 col-xl-3">
              ...
              <div class="chart sparkline" ><i class="material-icons">group</i></div>
                ...
                <?php
                                ...
                                $stmt->close();
                  ?>
                  <div class="desc">Dev` Lanners</div>
                  <div class="value"><span class="indicator indicator-positive mdi mdi-chevron-right"></span><span class="number" data-toggle="counter" data-end="<?php echo $total_users;?>">0</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-12 col-lg-6 col-xl-3">
              <div class="widget widget-tile">
              <div class="chart sparkline" ><i class="material-icons">live_help</i></div>
                <div class="data-info">
                <?php
                                //code for getting all devlan members
                                $result ="SELECT count(*) FROM password_resets where  	status !='approved'  ";
                                $stmt = $mysqli->prepare($result);
                                $stmt->execute();
                                $stmt->bind_result($total_resets);
                                $stmt->fetch();
                                $stmt->close();
                  ?>
                  <div class="desc">PWD Resets</div>
                  <div class="value"><span class="indicator indicator-positive mdi mdi-chevron-right"></span><span class="number" data-toggle="counter" data-end="<?php echo $total_resets;?>">0</span>
                  </div>
                </div>
              </div>
            </div>
                      ...
                      <script>
                            ...
                            var chart = new CanvasJS.Chart("chartContainer", {
                              ...
                              data: [{
                                ...
                                indexLabel: "{name} - {y}%",
                                dataPoints: [
                                  //Data Populated from database and represented by the pie chart 
                                  { y:
                                    <?php
                                  //code for getting all devlan members
                                  $result ="SELECT count(*) FROM projects where project_category ='FrontEnd WebApp'   OR  project_category = 'BackEnd WebApp' OR project_category = 'FullStack WebApp' OR project_category= 'Framework WebApp' OR project_category = 'Non Framework WebApp' OR project_category = 'Android App' OR project_category = 'Progressive WebApp' OR project_category = 'Misc Coding Projects'";
                    ...
                    <table class="table table-striped table-hover">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                              <a class="badge badge-success" href='devlan_pages_recent_projects.php?project_id=<?php echo $row->project_id;?>'><i class="mdi mdi-eye-outline"></i> View Project</a>
                           </td>
                        </tr>
                      </tbody>
                      <?php $cnt=$cnt+1; } ?>
