            ...
            <div class="col-12 col-lg-12">
              ...
              <div class="card card-table">
                <div class="card-header">
                  ...
                  <div class="title">Creator:<?php echo $row->user_email;?></div>
                  <embed src="../DevLan_Platform/assets/projects/<?php echo $row->project_files;?>" width="1000" height="500"  type="application/pdf">
                </div>
