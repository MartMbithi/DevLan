                  ...
                  <table class="table table-striped table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                            <a class= "badge badge-danger"  href='devlan_pages_manage_projects.php?del=<?php echo $row->project_id;?>' onClick= "return confirm('You Sure Wanna Delete This Project?');">
                                <i class=" mdi mdi-delete-sweep"></i> Delete</a>
                        </td>
                      </tr>
                     </tbody>
                     <?php $cnt=$cnt+1; } ?>
