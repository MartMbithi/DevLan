<?php
  ...
  <nav class="navbar navbar-expand fixed-top be-top-header">
        <div class="container-fluid">
          ...
          <div class="page-title"><span>DevLan Administrator Dashboard</span></div>
                    ...
                    <div class="list">
                      <div class="content">
                        <div class="row">
                          ...
                          <div class="col"><a class="connection-item" href="https://devlan.martdev.info/f/" target = "_blank"><img src="assets/img/bitbucket.png" alt="Github"><span>Devlan Community</span></a></div>
