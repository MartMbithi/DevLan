            ...
            <div class="left-sidebar-scroll">
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li class="parent active"><a href=""><i class="icon mdi mdi-account-group"></i><span>Dev Lanners</span></a>
                    <ul class="sub-menu">
                    <li><a href="devlan_pages_manage_pwd_reset_requests.php">Password Reset Requests</a>
                      <li><a href="devlan_pages_manage_users.php">Manage</a>
                      </li>                     
                    </ul>
                  </li>
