...
<!-- Parallax Section
================================================== -->
<section class="pagetitle parallax parallax-image" style="background-image:url(assets/img/demo/business1.jpg);">
...
<section id="le_gang" class="page-wrapper gray wow zoomIn">
	...
	<div class="row team-wrap">
		<div class="col-md-4 col-sm-4 col-xs-12">
			<div class="team-boxes">
				<div class="team-thumb overlay-image view-overlay">
					<img src="{{ url('assets/img/demo/mark.jpg') }}" alt="Markov">
					<div class="clear">
					</div>
		...
		<div class="col-md-4 col-sm-4 col-xs-12">
			<div class="team-boxes">
				<div class="team-thumb overlay-image view-overlay">
					<img src="{{ url('assets/img/demo/alonso.jpg') }}" alt="Anatoli">
					<div class="clear">
					</div>
					<div class="mask team_quote">
						<div class="port-zoom-link">
		...
		<div class="col-md-4 col-sm-4 col-xs-12">
			<div class="team-boxes">
				<div class="team-thumb overlay-image view-overlay">
					<img src="{{ url('assets/img/demo/el efe.jpg') }}" alt="Juan">
					<div class="clear">
					</div>
					<div class="mask team_quote">
						<div class="port-zoom-link">
	...
	<div class="row team-wrap">
		<div class="col-md-4 col-sm-4 col-xs-12">
			<div class="team-boxes">
				<div class="team-thumb overlay-image view-overlay">
					<img src="{{ url('assets/img/demo/will_i_am.jpg') }}" alt="Thannos">
					<div class="clear">
					</div>
					<div class="mask team_quote">
						<div class="port-zoom-link">
		...
		<div class="col-md-4 col-sm-4 col-xs-12">
			<div class="team-boxes">
				<div class="team-thumb overlay-image view-overlay">
					<img src="{{ url('assets/img/demo/doris.jpg') }}" alt="Doris">
					<div class="clear">
					</div>
					<div class="mask team_quote">
						<div class="port-zoom-link">
		...
		<div class="col-md-4 col-sm-4 col-xs-12">
			<div class="team-boxes">
				<div class="team-thumb overlay-image view-overlay">
					<img src="{{ url('assets/img/demo/matt.jpg') }}" alt="Mustang 001">
					<div class="clear">
					</div>
					<div class="mask team_quote">
						<div class="port-zoom-link">
	...
	<div class="row team-wrap">
		<div class="col-md-4 col-sm-4 col-xs-12">
			<div class="team-boxes">
				<div class="team-thumb overlay-image view-overlay">
					<img src="{{ url('assets/img/demo/sejo.jpg') }}" alt="Sejo">
					<div class="clear">
					</div>
					<div class="mask team_quote">
						<div class="port-zoom-link">
		...
		<div class="col-md-4 col-sm-4 col-xs-12">
			<div class="team-boxes">
				<div class="team-thumb overlay-image view-overlay">
					<img src="{{ url('assets/img/demo/pptx.jpg') }}" alt="pptx">
					<div class="clear">
					</div>
					<div class="mask team_quote">
						<div class="port-zoom-link">
