      ...
      <div class="page-content">
        ...
        <div class="row justify-content-between align-items-center">
              ...
              <div class="d-inline-block">
                  <h5 class="h4 d-inline-block font-weight-400 mb-0 text-white">Dashboard / <b>Network Scripts</b></h5>
              </div>
        ...
        <!--GET ALL PROJECTS IN A CERTAIN ORDER--->
            <?php
                        ...
                        $ret="SELECT * FROM projects where project_category= 'Networking Scripts' ";
                        $stmt= $mysqli->prepare($ret) ;
