            ...
            <div class="card card-border-color card-border-color-primary">
              ...
              <!--Login Form-->
                ...
                <?php if(isset($error)) {?>
                      ...
                      <div class="message">
                          <button class="close" type="button" data-dismiss="alert" aria-label="Close"><span class="mdi mdi-close" aria-hidden="true"></span></button><strong><?php echo $error ?></strong>
                      </div>
                      </div>
                ...
                <!--End-->
                  ...
                  <div class="form-group pt-2">
                    <button class="btn btn-block btn-outline-success btn-xl" name="admin_signin" type="submit">Log In</button>
                  </div>                
                </form>
