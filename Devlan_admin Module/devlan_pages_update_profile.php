        ...
        <div class="page-head">
                <?php
                    ...
                    //sql to inset the values to the database
                        $query="update users set  fname=?, lname=?,  email=?, username=?, password=?, dob=?, phone=?, location=?, website=?, bio=?, skill=?, dpic=?, cover=?  where user_id=?";
                        $stmt = $mysqli->prepare($query);
                        //bind the submitted values with the matching columns in the database.
                        $rc=$stmt->bind_param('sssssssssssssi',$fname, $lname,  $email, $username, $password, $dob, $phone, $location, $website, $bio, $skill, $dpic, $cover, $id);
                        $stmt->execute();
                        //if binding is successful, then indicate that a new value has been added.
                        $msg = "Success Your Account Has Been Updated!";
                  echo 
              ...
              <div class="card card-border-color card-border-color-primary">
                ...
                <div class="card-body">
                  ...
                  <form  method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputPassword3">Password</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                    ...
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="file-1">Cover Photo</label>
                      <div class="col-12 col-sm-6">
                        <input class="inputfile" id="file-1" type="file" name="cover" data-multiple-caption="{count} files selected" multiple>
                        <label class="btn-secondary" for="file-1"> <i class="mdi mdi-upload"></i><span>Browse files...</span></label>
                      </div>
                    </div>
                    <hr>
