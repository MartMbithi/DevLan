      ...
      <div class="page-content">
        ...
        <div class="row justify-content-between align-items-center">
              ...
              <div class="d-inline-block">
                  <h5 class="h4 d-inline-block font-weight-400 mb-0 text-white">Dashboard / <b>Settings</b></h5>
              </div>
                            ...
                            ?>
                             <div class="card text-center">
                                ...
                                <div class="card-body">
                                  ...
                                  <a href='user_projects_settings.php?del=<?php echo $row->project_id;?>' onClick= "return confirm('You Sure You Want To Delete This Project?');"  class="btn btn-outline-danger">Delete Project</a>
                                </div>
                              </div>
              <?php }?>  
        </div>
