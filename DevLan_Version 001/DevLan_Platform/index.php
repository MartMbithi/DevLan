                              ...
                              else
                              {
                                ...
                                echo 
                                  '<div class="alert alert-danger alert-icon alert-dismissible" role="alert">
                                    <div class="icon"><span class="mdi mdi-emoticon-dead"></span></div>
                                        <div class="message">
                                            <button class="close" type="button" data-dismiss="alert" aria-label="Close"><span class="mdi mdi-close" aria-hidden="true"></span></button><strong>'.$error.'</strong>
                                        </div>
                                </div>';
                              }
                          }
              ...
              <!--Login Form-->
                <form method ="POST">
                  ...
                  <div class="form-group row login-tools">
                    ...
                    <div class="col-6 login-forgot-password"><a href="password_resets/">Forgot Password?</a></div>
                  </div>
                  <div class="form-group pt-2">
                    <button class="btn btn-block btn-primary btn-xl" name="user_signin" type="submit">Sign Up</button>
                  </div>                
                </form>
